...
?></pre>
    ...
    <form action="" method="post">
        <fieldset>
            ...
            <input type="email" id="email_val" name="email" value="" placeholder="Email address" />
            <br />
            <p id="email_msg"></p>
            <input type="password" id="pwd_val" name="password1" value="" placeholder="Your password" />
            <br />
            <p id="pwd_msg"></p>
            <input type="password" name="password2" value="" placeholder="Confirm your password" />
            <br />
    ...
    <script type="text/javascript" src="validation_email_pwd.js">
    </script>
